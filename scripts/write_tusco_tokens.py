...
with open("./bert_dataset/train_tusco_tokens.txt", "w") as f:
    for token in all_tokens[0:int(doc_length*0.7)]:
        f.write(token + " ")

with open("./bert_dataset/valid_tusco_tokens.txt", "w") as f:
    for token in all_tokens[int(doc_length*0.7):]:
        f.write(token + " ")
